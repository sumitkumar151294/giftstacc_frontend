                ...
                <div class="row gx-0">
                    <div class="col-12 col-md-8 pb-3 mb-3 border-bottom">
                        <ul class="list-inline m-0 text-center text-md-start">
                            ...
                            <li class="list-inline-item"><a  class="clr-white">My Profile</a></li>
                            <li class="list-inline-item"><a  class="clr-white">My Orders</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-12 col-md-12 order-mobile-last text-center">
                        <ul class="list-inline m-0 fs-12 text-center text-md-start">
                            ...
                            <li class="list-inline-item">LC Loyalty-Program</li>
                            <li class="list-inline-item">Site Map</li>
                        </ul>
                    </div>
