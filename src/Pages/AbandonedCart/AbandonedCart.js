...
const AbandonedCartReport = () => {
  ...
  const placeholder_Mobile_Email_Name = GetTranslationData(
    "UIAdmin",
    "placeholder_Mobile_Email_Name"
  );
  ...
  const total_Cart_Value = GetTranslationData(
    "UIAdmin",
                ...
                <div key={index} className="scroll p-0">
                  <div className="d-flex justify-content-between weak scroll">
                    ...
                    <div className="pl-pr">
                      ...
                      <button
                        type="button"
                        className="btn btn-rounded btn-secondary btn-xxs nowrap"
                      >
                        <i className="fa fa-info"></i> &nbsp;{data.action}{" "}
                      </button>{" "}
                    </div>
                  </div>
                </div>
