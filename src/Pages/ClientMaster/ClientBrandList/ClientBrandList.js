                                ...
                                <div className="container-fluid mt-2 mb-2">
                                    <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                                        ...
                                        <div className="d-flex align-items-center flex-wrap">
                                            <a href="" className="btn btn-primary btn-rounded me-3 mb-2"><i className="fa fa-file-excel me-2"></i>{exportLabel}</a>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                {customerdetails.map((data) => (
                                                    <tr>
                                                        ...
                                                        <td><div className="input-group mb-2 w-11">
                                                            <input type="number" className="form-control update-val" placeholder={data.discount} pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==2) return false;" />
                                                            <div className="input-group-append">
                                                                <button className="btn btn-outline-primary btn-sm group-btn" type="button">{update}</button>
                                                            </div>
                                                        </div></td>
                                                        <td><div className="input-group mb-2 w-11">
                                                            <input type="number" className="form-control update-val" placeholder={data.commision} pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==2) return false;" />
                                                            <div className="input-group-append">
                                                                <button className="btn btn-outline-primary btn-sm group-btn" type="button">{update}</button>
                                                            </div>
                                                        </div></td>
