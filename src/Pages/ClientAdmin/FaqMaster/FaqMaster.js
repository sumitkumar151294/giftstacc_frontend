...
const FaqMaster = () => {
  ...
  useEffect(() => {
    ...
    } else if (faqMasterGetData.message?.data?.HttpStatusCode === "500") {
      toast.error(faqMasterGetData.message?.data.ErrorMessage);
      dispatch(onFaqMasterSubmitReset());
    } else if (faqMasterGetData?.getmessage?.status === 404) {
      setShowError(true);
      setPageError({
        StatusCode: "404",
        ErrorName: "not found",
                            ...
                            {faqMasterGetData.getData?.length > 5 && (
                              <div className="pagination-container">
                                <ReactPaginate
                                  ...
                                  breakLabel={"..."}
                                  pageCount={Math.ceil(
                                    faqMasterGetData.getData?.length /
                                      rowsPerPage
                                  )}
