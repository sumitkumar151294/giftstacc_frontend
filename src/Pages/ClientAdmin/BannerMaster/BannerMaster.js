    ...
    useEffect(() => {
      ...
      if (prefilledData) {
        ...
        setBannerMaster({
          ...
          webImage: prefilledData?.webImage || "", // Retain the existing image
          mobileImage: prefilledData?.mobileImage || "", // Retain the existing image
          enabled:
            prefilledData?.enabled !== undefined ? prefilledData?.enabled : "",
        });
  console.log(prefilledData?.mobileImage )
  console.log(prefilledData?.webImage )
        ...
        if (!prefilledData) {
          ...
          dispatch(
            onUpdateBannerMaster({
              ...
              buttonLink: bannerMaster.buttonLink,
              clientId: clientId,
              startDate: bannerMaster?.startDate,
      endDate: bannerMaster?.endDate
            })
          );
        }
      }
                        ...
                        <div className="row">
                          ...
                          <div className="col-sm-4 form-group mb-2">
                            ...
                            <InputField
                              type="text"
                              name="buttonLink"
                              className={`${errors.buttonLink ? "border-danger" : "form-control"}`}
